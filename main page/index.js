...
// mondayInHtml = document.querySelector(".monday")
// tuesdayInHtml = document.querySelector(".tuesday")
// wednesdayInHtml = document.querySelector(".wednesday")
// thursdayInHtml = document.querySelector(".thursday")
// fridayInHtml = document.querySelector(".friday")
// saturdayInHtml = document.querySelector(".saturday")
